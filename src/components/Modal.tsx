                ...
                {isOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm" onClick={onClose}>
                        <motion.div
                            ...
                            className="bg-gradient-to-br from-white to-gray-50 dark:from-gray-800 dark:to-gray-900 rounded-2xl max-w-2xl w-full shadow-2xl relative overflow-hidden"
                        ...
                        >
                            ...
                            <button
                                onClick={onClose}
                                className="absolute top-4 right-4 z-10 w-8 h-8 flex items-center justify-center rounded-full bg-white/80 dark:bg-gray-700/80 text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white shadow-lg hover:shadow-xl transition-all duration-200 hover:scale-110"
                            >
                                ✕
                            </button>

                            {/* Postcard Image with Wishes Overlay */}
                            <div className="relative w-full h-96 bg-gradient-to-br from-red-100 to-green-100 dark:from-red-900/20 dark:to-green-900/20 overflow-hidden">
                                {postcardImage ? (
                                    <>
                                        <img
                                            src={postcardImage}
                            ...
                            <div className="p-8 space-y-8">
                                ...
                                <div className="flex items-center justify-between gap-8">
                                    ...
                                    <div className="flex flex-col gap-1">
                                        ...
                                        <span className="text-2xl md:text-3xl font-bold text-gray-800 dark:text-white">{sender}</span>
                                    </div>

                                    {/* Recipient with Generate Button */}
                                    <div className="flex flex-col gap-1 items-end">
                                        <span className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider">To</span>
                                ...
                                {isAlreadySent && (
                                    <div className="w-full py-4 px-6 rounded-lg font-semibold text-lg bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-400 text-center">
                                        ✅ Wishes Already Sent!
                                    </div>
                                )}
